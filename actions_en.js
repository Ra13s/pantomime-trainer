window.actionsData_en = [
    ...
    "Investigating a Clue Under a Streetlamp",
    "Monologue at a Smoky Bar",
    "Accidental Spill Meet-Cute",
    "Dramatic Airport Dash",
    ...
    "Protecting a Small Light Source",
    "Paranoid Glances",
    "Losing Grip on Reality",
    "Secretly Checking a Locked Door",
    "Gaslight Reaction",
    "Power-Up Pose",
    ...
    "Dramatic ‘Archive Footage’ Recreation",
    "Slow Tearful Confrontation",
    "Anguished Collapse",
    "Long Embrace Goodbye",
    "Pensive Window Stare",
    ...
    "Gathering Everyone in the Lounge",
    "‘Eureka’ Clue Revelation",
    "Big Opening Chorus",
    "Tap-Dance Break",
    "Finale Pose",
    ...
    "Voting Off a Teammate",
    "Over-the-Top Makeover Reveal",
    "Surprise Twist Reaction",
    "Pressing Futuristic Buttons",
    ...
    "Confronting Evil Twin",
    "Heart-Pounding Foot Chase",
    "Disabling a Bomb",
    "Hiding from an Assassin",
    "Finding a Cryptic Clue",
    "Receiving Fatal Prophecy",
    ...
    "Plugging into a Neural Jack",
    "Street Deal with Illegal Cybernetics",
    "Hacking on a Holo-Screen",
    "Fleeing Corporate Drones",
    "Spacewalk Repairs",
    "Rocket Launch Countdown",
    "First Contact Handshake",
    "Navigating Zero-Gravity Cabin",
    "Doors Open Both Ways",
    "Classic Rake Gag",
    "Exaggerated Fall Down Stairs",
    ...
    "Admiring Pristine Environment",
    "Using Advanced, Effortless Technology",
    "Sudden Realization of Hidden Secret",
    "Scanning ID at a Security Checkpoint",
    "Hiding from Surveillance Drone",
    "Hoarding Rations",
    "Defying the Rules",
    "Grand Starship Bridge Command",
    "Wielding a Laser Sword",
    "Receiving a Galactic Transmission",
    "Revealing a Royal Galactic Lineage",
    "Arguing in the Police Car",
    "High-Five After a Bust",
    "Reluctant Apology",
    "Bust in Together",
    "Perfectly Centered Entrance",
    "Deadpan Delivery While Passing Props",
    "Slow-Motion Group Walk",
    "Meticulous Tea Preparation",
    "Grand Bow to the Damsel",
    "Over-the-Top Cry of Distress",
    "Fast-Forward Chase Scene",
    "Sudden Group Dance",
    "Romantic Swirl",
    "Dramatic Rain Dance",
    "Festival of Colors",
    "Checking a Gadget Watch",
    "Villain’s Lair Escape",
    ...
    "Rain-Soaked Confession",
    "Butler Announcing Guests",
    "Polishing Silver in the Servants’ Quarters",
    "Dressing for Dinner",
    "Eavesdropping from the Staircase"
];